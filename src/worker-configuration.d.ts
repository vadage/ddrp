/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 81ac808b5ecfc31a8c917a5d1a3483e5)
// Runtime types generated with workerd@1.20250730.0 2025-08-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		MESSAGES: KVNamespace;
		APP_URL: 'http://localhost:5173' | 'https://ddrp.fyi';
		HMAC_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<Cloudflare.Env, 'APP_URL' | 'HMAC_SECRET' | 'KEY_DERIVATION_SECRET'>
		> {}
}
